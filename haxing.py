...
def register(userName, email, password):
    ...
    try:
        c.get('https://haixingcloud.com/#/Home')
        c.find_element_by_xpath('//*[@id="navbar-example"]/div/ul/dl/dt/a[1]/span').click()
        c.find_element_by_xpath('//*[@id="agree-register-protocol"]').click()
        c.find_element_by_xpath('//*[@id="MKtCF1"]').send_keys(userName)
        c.find_element_by_xpath('//*[@id="EuadN0"]').send_keys(email)
        c.find_element_by_xpath('//*[@id="p9SagS"]').clear()
        c.find_element_by_xpath('//*[@id="p9SagS"]').send_keys(password)
        c.find_element_by_xpath('//*[@id="twTAQf"]').clear()
        c.find_element_by_xpath('//*[@id="twTAQf"]').send_keys(password)
        #get_my_validcode(c)
        for i in range(8):
            time.sleep(1)
            print("已经睡眠"+ str(i) +"秒")
...
for i in range (999):
    _emailType = ["@qq.com","@163.com","@hotmail.com"]
